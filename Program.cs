using System.Linq; //ця штука як max(a, b) в пайтоні. якщо тобі не треба то не звертай увагу
// mainS = рядки що обєднані у один рядок, назва усюди для нього однакова
// dict = словник створений із mainS. слово - ксть слів
